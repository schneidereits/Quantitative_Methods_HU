...
m_lme4 <- lmer(ELA ~ debris_cov + length + area + P_snow + P_monsoon + P_not_monsoon +  T_mean_mea.yr +  T_variability + Slope_mean + Elev_max + Elev_mean + (1|morph_type) + (1|orientation), data = glacier_scaled) 
summary(m_lme4)
...
m_saturated <-
  glm( ELA ~ debris_cov  + morph_type + orientation + length  + area  + P_snow + P_year + P_monsoon + P_not_monsoon +
  T_MIN_mean_monsoon + T_MIN_mean_not_monsoon + T_MAX_mean_monsoon + T_MAX_mean_not_monsoon + T_mean_mea.yr + T_mean_monsoon +   T_mean_not_monsoon + Slope_min + Slope_max + Slope_mean + Elev_min + Elev_max + Elev_mean + T_variability,
  data = glacier_scaled,
  family = "gaussian") 
