...
# From our confusion matrix of the training data we can see that 13747 instances of noise where corretly disciminated and 1163 pulsars where correctly identified. There where 73 false positves and 230 false negatives. This is a substaintail improvment over the previouses model pulsar dection for the train data
